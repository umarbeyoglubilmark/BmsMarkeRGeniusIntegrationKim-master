...
/*REPLACE BEGIN FOR DISTINCT*/
	...
	,DOCUMENT_NO
	,DATE_=					G3B.TDATE
	,BRANCH=				(SELECT MM.LogoBranch FROM Bms_124_MarkeRGeniusIntegration_Mapping MM where PosBranch=FK_STORE)
	,CUSTOMER_CODE=			CASE WHEN CUSTOMER_CODE='' THEN (SELECT TOP 1 DD.Value FROM Bms_124_MarkeRGeniusIntegration_Default DD WHERE DD.Description='YAZARKARA FISLI CARI BOS LOGO CARISI') ELSE CUSTOMER_CODE END
	,CUSTOMER_NAME
	,POS=					FK_POS
	,FTYPE
	/*,PTYPE*/
	...
	/*select * from [[BMSF_124_PennaGenius_Sales_WithCustomer]]('12/26/2023 00:00:00','12/26/2023 23:59:59') where LINE_TOTL_DISCOUNT<>0*/
