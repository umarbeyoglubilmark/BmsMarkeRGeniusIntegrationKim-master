...
/*REPLACE BEGIN FOR DISTINCT*/
	DATE_=					G3B.TDATE
	,BRANCH=				(SELECT MM.LogoBranch FROM Bms_124_MarkeRGeniusIntegration_Mapping MM where PosBranch=FK_STORE)/*CASE FK_STORE WHEN '10001' THEN '0' WHEN '10002' THEN '2' WHEN '10003' THEN '1' END*/
	,POS=					FK_POS
	,FTYPE
	...
	/*select * from [BMSF_124_PennaGenius_Sales]('12/26/2023 00:00:00','12/26/2023 23:59:59') where LINE_TOTL_DISCOUNT<>0*/
