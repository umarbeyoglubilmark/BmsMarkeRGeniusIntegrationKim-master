...
/*REPLACE BEGIN FOR DISTINCT*/
	DATE_=					G3B.TDATE
	,BRANCH=				(SELECT MM.LogoBranch FROM Bms_125_MarkeRGeniusIntegration_Mapping MM where PosBranch=FK_STORE)/*CASE FK_STORE WHEN '10001' THEN '0' WHEN '10002' THEN '2' WHEN '10003' THEN '1' END*/
	,POS=					FK_POS
	,FTYPE
	...
	/*select * from [BMSF_125_PennaGenius_Sales]('12/26/2023 00:00:00','12/26/2023 23:59:59') where LINE_TOTL_DISCOUNT<>0*/
...
WHERE     ((/* satislar	*/ TRANSACTION_HEADER.PTYPE NOT IN (2, 6) AND TRANSACTION_SALE.STATUS = 0 AND TRANSACTION_HEADER.STATUS = 0) OR
                      ...
                      TRANSACTION_HEADER.TRANS_DATE BETWEEN @DATE1 AND @DATE2 AND (TRANSACTION_HEADER.CUSTOMER_CODE = '' AND TRANSACTION_HEADER.DOCUMENT_NO='')
